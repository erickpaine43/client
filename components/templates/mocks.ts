...
export const userTemplates: Template[] = [
  {
    ...
    bodyHtml:
      "<p>Hi {First Name},</p><p>I hope this email finds you well...</p>",
    description:
      "A personalized first touch to CEOs highlighting their company achievements",
  ...
  },
  {
    ...
    bodyHtml:
      "<p>Hi {First Name},</p><p>I wanted to briefly introduce our SaaS solution...</p>",
  ...
  },
  {
    ...
    bodyHtml:
      "<p>Hi {First Name},</p><p>I'm just following up on my previous email...</p>",
  ...
  },
  {
    ...
    bodyHtml:
      "<p>Hi {First Name},</p><p>I'd like to schedule a brief meeting to discuss...</p>",
  ...
  },
  {
    ...
    bodyHtml:
      "<p>Hi {First Name},</p><p>I thought you might be interested in this case study...</p>",
  ...
  },
  {
    ...
    bodyHtml:
      "<p>Hi {First Name},</p><p>Since I haven't heard back, I'm closing the loop on this...</p>",
    description:
      "Final follow-up message before closing the conversation thread",
...
export const builtInTemplates: Template[] = [
  {
    ...
    bodyHtml:
      "<p>Hello {First Name},</p><p>I noticed that {Company} has been...</p>",
    description:
      "Request a demo for your SaaS product with clear value proposition",
  ...
  },
  {
    ...
    bodyHtml:
      "<p>Hi {First Name},</p><p>I trust this message finds you well...</p>",
    description:
      "Perfect for marketing or creative agencies to introduce their services",
    createdAt: new Date("2024-01-01"),
    updatedAt: new Date("2024-01-01"),
    companyId: 1,
    createdById: "user1",
  },
  {
    ...
    bodyHtml:
      "<p>Hi {First Name},</p><p>I hope this email reaches you in good spirits...</p>",
  ...
  },
  {
    ...
    bodyHtml:
      "<p>Hi {First Name},</p><p>I am reaching out to explore potential synergies...</p>",
    description:
      "Initiate partnerships with complementary e-commerce businesses",
    createdAt: new Date("2024-01-01"),
    updatedAt: new Date("2024-01-01"),
    companyId: 1,
    createdById: "user1",
  },
  {
    ...
    bodyHtml:
      "<p>Hi {First Name},</p><p>I am excited to share some exclusive real estate...</p>",
  ...
  },
  {
    ...
    bodyHtml:
      "<p>Hi {First Name},</p><p>I hope this message finds you well...</p>",
  ...
  },
  {
    ...
    bodyHtml:
      "<p>Hi {First Name},</p><p>I am reaching out to introduce our comprehensive...</p>",
  ...
  },
  {
    ...
    category: "HEALTHCARE",
    subject:
      "Revolutionizing Healthcare with Innovative Solutions for {Company}",
    body: "Hi {First Name},\n\nI am excited to present our cutting-edge healthcare...",
    bodyHtml:
      "<p>Hi {First Name},</p><p>I am excited to present our cutting-edge healthcare...</p>",
