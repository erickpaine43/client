...
export const pricingContent = {
  hero: {
    ...
    description:
      "Simple, transparent pricing for businesses of all sizes. Start warming up your domains and sending campaigns today.",
  },
  plans: {
    business: {
      title: "Business",
    ...
    custom: {
      title: "Custom",
      description:
        "Tailored solutions for large enterprises or specific needs.",
      price: "Contact Us",
      features: [
